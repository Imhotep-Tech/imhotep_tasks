...
const EmailVerification = () => {
  ...
  const getButtonLink = () => (status === 'success' ? '/login' : '/register');
  const getButtonText = () => (status === 'success' ? 'Back to Login' : 'Register');
              ...
              <div className="mt-6">
                ...
                {status === 'error' && (
                  <div className="mt-4 text-sm text-gray-600">
                    If this problem persists, try <Link to="/register" className="text-blue-600 font-medium">registering again</Link> or contact support.
                  </div>
                )}
              </div>
